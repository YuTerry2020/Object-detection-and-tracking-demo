...
PATH_TO_LABELS = os.path.join(CWD_PATH,'training','garbage_labelmap.pbtxt')
...
category_index[1]['name'] = 'License'
category_index[2]['name'] = 'Garbage' 
...
def draw_box_label(class_id, id, img, bbox_cv2, box_color=(0, 255, 0), show_label=True):
    #box_color= (0, 255, 255)
    ...
    if show_label:       
        ...
        # else :
        #     object_name = 'garbage' 
        object_id = category_index[class_id]['name']+'_'+str(id)
